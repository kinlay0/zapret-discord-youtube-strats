...
set "GITHUB_VERSION_URL=https://raw.githubusercontent.com/kinlay0/zapret-discord-youtube-strats/main/.service/version.txt"
set "GITHUB_RELEASE_URL=https://github.com/kinlay0/zapret-discord-youtube-strats/releases/tag/"
set "GITHUB_DOWNLOAD_URL=https://github.com/kinlay0/zapret-discord-youtube-strats/releases/latest"
